...
export function Sidebar() {
    ...
    return (
        <>
            ...
            <aside className={`fixed inset-y-0 left-0 z-40 w-64 bg-card border-r border-border transition-transform duration-300 transform ${isOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0 flex flex-col`}>
                <div className="p-6 flex-1 overflow-y-auto">
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] text-muted-foreground font-bold tracking-widest uppercase">Inventario</p>
                        </div>
                    </div>
                ...
                <div className="p-6 border-t border-border space-y-6">
                    ...
                    {mounted && (
                        <div className="space-y-3">
                            ...
                            >
                                <span>MODO {resolvedTheme === "dark" ? "CLARO" : "OSCURO"}</span>
